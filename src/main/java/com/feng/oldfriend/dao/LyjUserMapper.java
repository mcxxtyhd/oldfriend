...
public interface LyjUserMapper {
    ...
    List<LyjUser> getAllVolunteerTop(@Param("searchText") String searchText);
     ...
     * description: 升级版 因为pagehelper无法对嵌套的service进行分页 所以将所有的查询语句写在sql之中
     */
    List<LyjUser> getUsersAdvanced(@Param("searchText") String searchText);
    ...
    /**
     * create by: yangchenxiao
     * create time: 2019/10/13 22:18
     * description: 根据UUID更改用户信息
     */
    int updateByPrimaryByUUID(LyjUser record);
