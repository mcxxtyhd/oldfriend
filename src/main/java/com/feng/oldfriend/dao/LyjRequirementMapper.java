...
public interface LyjRequirementMapper {
    ...
    Integer getLyjRequirementsCount(@Param("searchText") String searchText);
    ...
    Integer getLyjRequirementsByTypeIdCount(@Param("searchText") String searchText,@Param("typeId") Integer typeId);
